...
<strong>Error !</strong> Email already Exists, please try another Email... !</div>';
      ...
      $sql = "INSERT INTO users (username, first_name, last_name, mobile, email, password, roleid) VALUES (:username, :first_name, :last_name, :mobile, :email, :password, :roleid)";
      $stmt = $this->db->pdo->prepare($sql);
      $stmt->bindValue(':username', $username);
  ...
  public function selectAllRolesData()
  {
